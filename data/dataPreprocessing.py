...
TRAIN = [r'./data/bengaliai-cv19/train_image_data_0.parquet',
         r'./data/bengaliai-cv19/train_image_data_1.parquet',
         r'./data/bengaliai-cv19/train_image_data_2.parquet',
         r'./data/bengaliai-cv19/train_image_data_3.parquet']
